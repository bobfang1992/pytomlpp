...
public:
  ...
  static handle cast(const toml::date &src, return_value_policy /* policy */,
                     handle /* parent */) {
    // Lazy initialise the PyDateTime import
    if (!PyDateTimeAPI) {
      PyDateTime_IMPORT;
...
public:
  ...
  static handle cast(const toml::time &src, return_value_policy /* policy */,
                     handle /* parent */) {
    // Lazy initialise the PyDateTime import
    if (!PyDateTimeAPI) {
      PyDateTime_IMPORT;
...
public:
  ...
  static handle cast(const toml::date_time &src,
